...
class AccuService @Inject constructor(
    ...
    /**
     * Accu returns 0 / mÂ³ for all days if they donâ€™t measure it, instead of null values
    ...
    override var portal: AccuPortalPreference
        ...
        get() = AccuPortalPreference.getInstance(
            if (apikey.isEmpty() || apikey == BuildConfig.ACCU_WEATHER_KEY) {
                // Force portal to make sure a user didnâ€™t select a portal incompatible with the default key
                "enterprise"
            } else {
