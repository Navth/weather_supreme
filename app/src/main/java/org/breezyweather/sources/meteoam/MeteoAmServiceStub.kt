...
abstract class MeteoAmServiceStub(context: Context) :
    ...
    private val weatherAttribution = "Servizio Meteorologico dellâ€™Aeronautica Militare. Informazioni elaborate " +
        "utilizzando, tra lâ€™altro, dati e prodotti del Servizio Meteorologico dellâ€™Aeronautica Militare pubblicati " +
    ...
    // This source is really inconsistent. Many missing, half correct, half â€œincorrectâ€
